<?
    ...
    */
	...
	font-size: 18px !important;
      ...
      .newsletter[subscription_status="success"] #success-message
      {
        display: block;
      }
      .newsletter[subscription_status="success"] .newsletter-container
      {
        display: none;
      }
    ...
    <div class="newsletter" subscription_status="<?= $subscription_status; ?>">
...
<div class="sib-form" style="text-align: left; background-color: #FFF;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="success-message" class="sib-form-message-panel">
      <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
        <span class="sib-form-message-panel__inner-text">Subscription confirmed!</span>
      </div>
    </div>
    <div></div>
